...
<div class="pageContent">
	<form method="post" id="sysptomitem_result_pay_from_id" action="demo/common/ajaxDone.html" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<table class="table">
			<thead>
		...
		<div class="pageFormContent" layoutH="76">
			 ...
			 <table>
			    ...
			    <tr height="30">
			       ...
			       <td><dd><input name="sick_name" id="sick_name" type="text" maxlength="10" /></dd></td>
			    </tr>
			     ...
			     <tr height="30">
			       ...
			       <td><dd><input name="sick_age" id="sick_age" type="text"  /></dd></td>
			    </tr>
			    ...
			    <tr height="30">
				    <td><dt style="text-align: right;">处方：</dt></td>
			    ...
			    <tr height="60">
				    <td><dt style="text-align: right;">&nbsp;</dt></td>
					<td colspan="3"style="color: red; font-weight: bold;line-height: 20px">鉴于您选择的症状准确度和既往病史等因素，本结果仅供参考，要得到更准确的诊断及处方，<br>最好填写好主诉和病史，请医生确认</td>
			    </tr>
		    </table>	
