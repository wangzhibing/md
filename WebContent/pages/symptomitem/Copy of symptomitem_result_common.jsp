	...
	<form method="post" action="demo/common/ajaxDone.html" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<div class="pageFormContent" layoutH="76">
			...
			<dl>
			    ...
			    <dd><input name="sick_name" id="sick_name" type="text" maxlength="10" /></dd>
			</dl>
			...
			<dl class="nowrap">
				...
				<dd><textarea name="textarea4" cols="80" rows="3" maxlength="150" id="report">${diagnoseResult.report }</textarea></dd>
			</dl>
			<dl class="nowrap">
				<dt style="text-align: right;">病史与检查：</dt>
				<dd><textarea name="textarea4" cols="80" rows="3" maxlength="150" id="medical_history">${diagnoseResult.medical_history }</textarea></dd>
			</dl>
