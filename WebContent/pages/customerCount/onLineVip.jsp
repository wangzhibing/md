...
<form method="post" rel="pagerForm" action="<%=basePath%>md/customerCount/queryRegisterOnlineCustomerInfo.do?customer_type=2&is_on_line=1"  onsubmit="return navTabSearch(this)">
</form>
