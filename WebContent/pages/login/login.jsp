...
<div id="login-container">
	...
	<form action="<%=basePath%>md/customer/loginIn.do" onsubmit="return loginIn()"/>
				<fieldset>
		...
		<div id="login-extra">
			...
			<p><a href="<%=basePath%>pages/login/loginAdmin.jsp">管理员登录</a> 没有账号? <a href="<%=basePath%>pages/login/regist.jsp">注册</a>.或者以<a href="<%=basePath%>md/customer/mainForward.do">游客</a>身份登录</p>
