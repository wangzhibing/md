	...
	<form method="post" action="demo/common/ajaxDone.html" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<div class="pageFormContent" layoutH="76">
			 ...
			 <table>
			   ...
			   <tr height="30">
			    ...
			    <tr height="30">
				    <td valign="top"><dt style="text-align: right;">处方：</dt></td>
					<td colspan="3"><textarea name="textarea4"  maxlength="200" cols="77" rows="3" id="prescription6_medicinal">${diagnoseResult.prescription5_medicinal }</textarea></dd></td>
			    </tr>
		...
		<div class="formBar">
			<ul style="float:none;margin-left: 120px;">
				<li><a class="button"  title="专家确诊" 
				       onclick=expertCheck(${diagnoseResult.diagnose_id }) ><span>医生确诊</span></a></li>
			</ul>
		</div>
	</form>
</div>
