...
<%-- action="<c:url value='<%=basePath%>md/medicinal/queryMedicinalData.do'/>" --%>
	<form method="post" rel="pagerForm" action="<%=basePath%>md/expert/queryExpertCheckedDiagnoseData.do" onsubmit="return navTabSearch(this)"> 
		<div class="searchBar"> 
...
<div class="pageContent">
	...
	<li hidden="hide" style="display: none;"><a class="icon" href="<%=basePath%>/md/symptomItemValue/doSymptomItemJspExpertHis.do?diagnoseResultId={slt_objId}&viewType=1"  target="navTab" rel="expertCheckedDiagnoseRel" id="expertCheckedDiagnoseRel_id" mask="true"><span>诊断详情</span></a></li>
	...
	<table class="table" width="100%" layoutH="112">
		...
		<c:forEach var="item" items="${expertCheckedDiagnoseList}" varStatus="s">
...
function dbltable(target,rel){
	if( target == 'slt_objId'){
		var expertCheckedDiagnoseRel_a = document.getElementById("expertCheckedDiagnoseRel_id");
		expertCheckedDiagnoseRel_a.click();
	}
}
</script>