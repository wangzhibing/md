...
public class PDFUtils {
	...
	public void writePdf(DiagnoseResult diagnoseResult,Customer customer,String generateFilePath,String docSignPath) throws Exception {
		...
		table.addCell(createCell(diagnoseResult.getDiagnose_result_date()+" "+diagnoseResult.getDiagnose_result_time(), textfont, 0));
		...
		table.addCell(createCell(customer.getName(), textfont, 0));
		...
		table.addCell(createCell(sick_sex, textfont, 0));
		table.addCell(createCell("病人年龄：", keyfont, 2));
		table.addCell(createCell(""+diagnoseResult.getSick_age(), textfont, 0));
		
		//第四行
		table.addCell(createCell("主诉：", keyfont, 2));
		table.addCell(createCell(diagnoseResult.getReport(), textfont, 0,3));
		
		//第五行
		table.addCell(createCell("病史与检查：", keyfont, 2));
		table.addCell(createCell(diagnoseResult.getMedical_history(), textfont, 0,3));
		
		//第六行
		table.addCell(createCell("输入的症状：", keyfont, 2));
		table.addCell(createCell(diagnoseResult.getLessSymptomValue(), textfont, 0,3));
		
		//第七行
		table.addCell(createCell("主要症状：", keyfont, 2));
		table.addCell(createCell(diagnoseResult.getSymptom_prescription_name(), textfont, 0,3));
	  
		//第八行
		table.addCell(createCell("（内）病位：", keyfont, 2));
		table.addCell(createCell(diagnoseResult.getIn_bw_first_name()+"，"+diagnoseResult.getIn_bw_second_name(), textfont, 0));
		...
		table.addCell(createCell(diagnoseResult.getIn_by_first_name()+"，"+diagnoseResult.getIn_by_second_name(), textfont, 0));
		...
		table.addCell(createCell(diagnoseResult.getPrescription6_medicinal(), textfont, 0,3));
		...
		table.addCell(createCell("doc", textfont, 0,3));
...
//		ppt.writePdf("诊断结果输出", "sdfsdfasdfasdfsdfasdf", "时间", "作者");
